...
<html>
    ...
    <!-- menu -->
        ...
        <div class="menuprincipal" id="menuprinc">
            ...
            <li id="esp">
                ...
                <a  style="color:white;text-decoration:none ;"> <ul class="ulmenu"><p class="p3"> Jogos </p> <img src="imagem/branco.png" class="imagem"></ul></a>
    ...
    <div id="principal">
        <p style="font-size:36px ;margin-bottom: 25px;">Jogos </p>
