...
<html>
    ...
    <!-- menu -->
        ...
        <div class="menuprincipal" id="menuprinc">
            ...
            <li id="esp">
                <a href="arquivos.php" style="color:white;text-decoration:none ;"><ul class="select"><p class="p3" >Todos os Arquivos </p> <img src="imagem/branco.png" class="imagem"></ul></a>
                ...
                <a  style="color:white;text-decoration:none ;"> <ul class="ulmenu"><p class="p3"> Trabalho </p> <img src="imagem/branco.png" class="imagem"></ul></a>
    ...
    <div id="principal">
        <p style="font-size:36px ;margin-bottom: 25px;">Trabalho </p>
